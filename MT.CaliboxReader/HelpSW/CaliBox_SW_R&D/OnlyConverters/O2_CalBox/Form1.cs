...
namespace O2_CalBox
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (A != "")
            {
                ...
                if ((Y[0] == "g901") || (Y[0] == "g903") || (Y[0] == "g100"))
                {
                    try
                    {
                        ...
                        switch (aa)
                        {
                            ...
                            case Constants.VerifyNTC_25: labelBoxStatus.Text = "VerifyNTC_25"; break;
                            ...
                            case Constants.VerifyPT1000_20: labelBoxStatus.Text = "VerifyPT1000_20"; break;
                            case Constants.VerifyPT1000_30: labelBoxStatus.Text = "VerifyPT1000_30"; break;

                            case Constants.VerifyUpol_500: labelBoxStatus.Text = "VerifyUpol_500"; break;
                            case Constants.VerifyUpol_674: labelBoxStatus.Text = "VerifyUpol_674"; break;
                ...
                if ((Y[0] == "g901") || (Y[0] == "g903") || (Y[0] == "g100"))
                {
                    ...
                    //    {
                    //        sw.WriteLine("Time;Command;BoxStatus;CalibrationStatus;Soll;Mean;StdDev;Error;Soll;Mean;StdDev;Error");
                    //        //sw.WriteLine(line_to_log);
                    //        sw.Write(line_to_log);
                    //    }
                    //}
        ...
        void DispatchSensorPage(string stream)
        {
            ...
            try
            {
                switch (page)
                {
                    ...
                    case 29:
                        NTC_CalVal_25.Text = Convert.ToString(bytes[i + 1] * 256 + bytes[i]); i += 2;
                        PT1000_CalVal_20.Text = Convert.ToString(bytes[i + 1] * 256 + bytes[i]); i += 2;
                        PT1000_CalVal_30.Text = Convert.ToString(bytes[i + 1] * 256 + bytes[i]); i += 2;
        ...
        private void button34_Click(object sender, EventArgs e)
        {
            try
            {
                serialPort1.Write("G914");
            }
            catch { MessageBox.Show("Comport ist geschlossen"); }

        }

        private void ReadP13Button_Click(object sender, EventArgs e)
        {
            try
            {
                serialPort1.Write("#RDPG 29");
        ...
        private void WriteP13Button_Click(object sender, EventArgs e)
        {
            string s;
            int ntc_calval_25;
            int pt1000_calval_20;
            int pt1000_calval_30;

            uint Byte_cnt = 0;
            byte CS = 0;
            try
            {
                ntc_calval_25 = Convert.ToInt16(NTC_CalVal_25.Text);
                pt1000_calval_20 = Convert.ToInt16(PT1000_CalVal_20.Text);
                pt1000_calval_30 = Convert.ToInt16(PT1000_CalVal_30.Text);

                // P31 Calibrated RawValues from Box
                CS += ((byte)ntc_calval_25); s = ((byte)ntc_calval_25).ToString("X2"); Byte_cnt++;
                CS += ((byte)(ntc_calval_25 >> 8)); s += ((byte)(ntc_calval_25 >> 8)).ToString("X2"); Byte_cnt++;
                CS += ((byte)pt1000_calval_20); s += ((byte)pt1000_calval_20).ToString("X2"); Byte_cnt++;
                CS += ((byte)(pt1000_calval_20 >> 8)); s += ((byte)(pt1000_calval_20 >> 8)).ToString("X2"); Byte_cnt++;

                CS += ((byte)pt1000_calval_30); s += ((byte)pt1000_calval_30).ToString("X2"); Byte_cnt++;
                CS += ((byte)(pt1000_calval_30 >> 8)); s += ((byte)(pt1000_calval_30 >> 8)).ToString("X2"); Byte_cnt++;


                CS ^= 0xFF;
                CS += 1;

                s = "#WRPG 29" + " " + CS.ToString("X2") + s; Byte_cnt++;
                //s = "#WRBX 10 " + "0E" + s; Byte_cnt++;
                for (uint i = Byte_cnt; i < 32; i++)
                {
                    s += ((byte)(0)).ToString("X2");
