    ...
    public partial class UC_DataRead : UserControl
    {
        ...
        ****************************************************************************************/
        ...
        public UC_DataRead()
        {
            InitializeComponent();
            ObjRef();
            BGW_MessageWriter = BGW_MessageWriter.Initilise(BGW_MessageWriter_DoWork, BGW_MessageWriter_RunWorkerCompleted);
        ...
        ****************************************************************************************/
        ...
        private void Port_DataReceived(object sender, SerialDataReceivedEventArgs rcvdData)
        {
            ...
            //}
            BGW_MessageWriter = BGW_MessageWriter.Initilise(BGW_MessageWriter_DoWork, true, new string[] { portName, tString });
        ...
        private void BGW_MessageReader_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (port.IsOpen)
            {
                ...
                if (!string.IsNullOrEmpty(message))
                {
                    ...
                    BGW_MessageWriter = BGW_MessageWriter.Initilise(BGW_MessageWriter_DoWork, BGW_MessageWriter_RunWorkerCompleted, true, values);
                }
            }
        }
