    ...
    public static class clConfig
    {
        ...
        ****************************************************************************************/
        ...
        public static List<UC_Channel> Load_Channels()
        {
            try
            {
                ...
                foreach (var com in Config_PortList)
                {
        ...
        ****************************************************************************************/
        private static void Error(string path, bool active)
        {
            ...
            ErrorPathLog = path;
            ErrorPathLog_Active = active;
        }
        public static void Load()
        {
            FTDI_UpdateSec = 30;
            Load_InitValues();
            Error(Config_Initvalues.LogError_Path, Config_Initvalues.LogError_Active);
            Load_ChangeValues();
            Load_BeM();
            Load_SerialPorts(Config_Initvalues.CHquantity);
        }
        ...
        private static List<string> BeMnames;
        private static void Load_BeM()
        {
            Register_BeM Config_BeM = Register_BeM.GetConfig();
            Config_BeMList = Config_BeM.Init_BeM_All();
            BeMnames = new List<string>();
            foreach (var item in Config_BeMList)
            {
                BeMnames.Add(item.BeM_Name);
            }
        }
        ...
        private static void Load_SerialPorts(int chQuantity)
        {
            ...
            foreach (Element_ComPorts item in Config_ComPorts.ComPorts)
            {
                if (item.Index < Config_Initvalues.CHquantity)
                {
                    try
                    {
                        COMvalues values = new COMvalues()
                        {
                            ...
                            TimeOut_Read = 2000,
                            TimeOut_Write = 2000,
                            ReadDelay = item.COMreadDelay,
                            ReadLine = item.BufferReadLine,
                            DeviceSN = item.FTDIname,
                        };
                        UC_COM.ConType type = item.ModusFTDI ? UC_COM.ConType.FTDI : UC_COM.ConType.ComPort;
                        foreach (var bem in Config_BeMsList)
                        {
                            if (bem.BeMname == item.BeM)
                            {
                                values.BaudRate = bem.Baudrate;
                                values.ReadDelay = bem.BeMdelay;
                                values.ReadLine = bem.BeMreadLine;
                                break;
                            }
                        }
                        UC_COM uc = new UC_COM(item.Index, item.Active, type, values, null, item.BeM, BeMnames);
        ...
        * Configuration:    FTDI
        ****************************************************************************************/
        public static int FTDI_UpdateSec
        {
            get { return UC_COM.Get_FTDI_UpdateTime(); }
            set { UC_COM.Set_FTDI_UpdateTime(value); }
        }

        public static DataTable DTFTDI { get { return UC_COM.FTDIdevicesDT; } }
        ...
        ****************************************************************************************/
        ...
        public static string[] SerialPortList
        {
            get
            {
                if ((DateTime.Now - COMcheck).TotalSeconds > FTDI_UpdateSec || _SerialPortList == null)
                {
        ...
        ****************************************************************************************/
        ...
        public class Register_BeM : ConfigurationSection
        {
            ...
            ****************************************************************************************/
            ...
            {
                return Find_inDefault(name, out _);
            }
            ...
            public List<Element_BeM> Init_BeM_All()
            {
                ...
                {
                    if (!Find_inConfig(element.BeM_Name, out _))
                    {
        ...
        ****************************************************************************************/
        ...
        public class Element_InitParameters : ConfigurationElement
        {
            ...
            const string K_LogError_Path = "LogError_Path";
            const string K_LogError_Active = "LogError_Active";

            const string K_LogMeas_Path = "LogMeas_Path";
            const string K_LogMeas_Path_Active = "LogMeas_Path_Active";
            const string K_LogMeas_DB_Active = "LogMeas_DB_Active";
            ...
            [ConfigurationProperty(K_LogError_Path)]
            public string LogError_Path
            {
                get { return (string)this[K_LogError_Path]; }
                set { this[K_LogError_Path] = value; }
            }

            [ConfigurationProperty(K_LogError_Active)]
            public bool LogError_Active
            {
                get { return (bool)this[K_LogError_Active]; }
                set { this[K_LogError_Active] = value; }
            }

            [ConfigurationProperty(K_LogMeas_Path)]
            public string LogMeas_Path
            {
                get { return (string)this[K_LogMeas_Path]; }
                set { this[K_LogMeas_Path] = value; }
            }

            [ConfigurationProperty(K_LogMeas_Path_Active)]
            public bool LogMeas_Path_Active
            {
                get { return (bool)this[K_LogMeas_Path_Active]; }
                set { this[K_LogMeas_Path_Active] = value; }
            }

            [ConfigurationProperty(K_LogMeas_DB_Active)]
            public bool LogMeas_DB_Active
            {
                get { return (bool)this[K_LogMeas_DB_Active]; }
                set { this[K_LogMeas_DB_Active] = value; }
            }
            ...
            {
                get { return (string)this[K_ProcNr]; }
        ...
        {
            static Register_InitParameters _Instance;
            ...
            {
                _Instance = new Register_InitParameters();
                if (ConfigFile.Config.Sections[SectionNameCollection] == null)
                {
                    ConfigFile.Config.Sections.Add(SectionNameCollection, _Instance);
                    Save();
                }
                else
                { _Instance = (Register_InitParameters)ConfigFile.Config.Sections[SectionNameCollection]; }
                return _Instance;
            }
            ...
            public static Element_InitParameters EmptyElement
            {
                get
                {
                    return new Element_InitParameters()
                    {
                        ...
                        CHquantity = 4,
                        ODBC_Init = "DO_Test",
                        LogMeas_Path_Active = true,
                        LogMeas_DB_Active = true,
                        LogMeas_Path = @"C:\TEMP\CaliboxReader",
                        LogError_Active = true,
                        LogError_Path = @"C:\TEMP\CaliboxReader\CaliboxReader_Error.log",
        ...
        ****************************************************************************************/
        ...
        public class Element_ChangeParameters : ConfigurationElement
        {
            ...
            const string K_ConverterHighestSN = "ConverterHighestSN";
            ...
            [ConfigurationProperty(K_ConverterHighestSN)]
            public int ConverterHighestSN
            {
                get { return (int)this[K_ConverterHighestSN]; }
                set { this[K_ConverterHighestSN] = value; }
            }
        ...
        {
            static Register_ChangeParameters _Instance;
            ...
            {
                _Instance = new Register_ChangeParameters();
                if (ConfigFile.Config.Sections[SectionNameCollection] == null)
                {
                    ConfigFile.Config.Sections.Add(SectionNameCollection, _Instance);
                    Save();
                ...
                { _Instance = (Register_ChangeParameters)ConfigFile.Config.Sections[SectionNameCollection]; }
                return _Instance;
            }
