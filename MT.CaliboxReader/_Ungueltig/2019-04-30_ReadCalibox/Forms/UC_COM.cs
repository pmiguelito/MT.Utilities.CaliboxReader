...
namespace ReadCalibox
{
    public partial class UC_COM : UserControl
    {
        ...
        ****************************************************************************************/
        ...
        void Init_Colors()
        {
            Form_Main.UC_TT.AllocFont(Lbl_CHname, 8.5f, FontStyle.Bold);
        ...
        ****************************************************************************************/
        ...
        public string PortName
        {
            get
            {
                if (CoB_COM.InvokeRequired) { return _PortName; }
                return CoB_COM.Text;
            }
            set
            {
                _PortName = value;
                if (!CoB_COM.InvokeRequired)
                { CoB_COM.Text = value; }
            }
        }
        ...
        * FTDI: Names
        ****************************************************************************************/
        private clFTDI _FTDI = new clFTDI();
