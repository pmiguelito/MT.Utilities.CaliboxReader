...
namespace ReadCalibox
{
    public class clLog
    {
        ...
        public void Save(UC_Channel ucCH, DeviceResponse response)
        {
            ...
            { BGW_MessageWriter = BGW_MessageWriter.Initilise(BGW_MessageWriter_DoWork, true, new LogValues() { Response = response, Channel = ucCH }); }
        }
        ...
        ****************************************************************************************/
        ...
        private void SaveLogMeasFile(LogValues log, string message, DeviceResponseValues drv)
        {
            ...
            {
                ErrorHandler("SaveLogMeas", information: $"ERROR: Directory {log.Channel.LogPathMeas} don't found");
            }
        }
