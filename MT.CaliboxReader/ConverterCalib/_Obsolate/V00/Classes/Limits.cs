...
namespace ConverterCalib
{
    class Limits
    {
        ...
        public bool ValueInRange { get { return LimitsValue.InRange(Value); } }

        public double Avg { get; private set; }
        public LimitsDetails LimitsAvg { get; set; }
        public bool AvgInRange { get { return LimitsAvg.InRange(Avg); } }
        
        public double StdDev { get; private set; }
        public LimitsDetails LimitsStdDev { get; set; }
        public bool StdDevInRange { get { return LimitsStdDev.InRange(StdDev); } }

        public double Min { get; private set; }
        public double Max { get; private set; }
        public LimitsDetails LimitsMinMaxDiff { get; set; }
        public double MinMaxDiff { get; private set; }
        public bool MinMaxDiffInRange { get { return LimitsMinMaxDiff.InRange(MinMaxDiff); } }
        ...
        public static LimitsProcDetails NTC_UNTC
        {
            get
            {
                if (_NTC_UNTC == null)
                {
                    ...
                    {
                        Values = new LimitsDetails(false, 12900, 9999, 9999),
                        Avg = new LimitsDetails(true, 12900, 9999, 9999),
                        StdDev = new LimitsDetails(true, 0, 0, 0.03),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
                return _NTC_UNTC;
            }
        ...
        public static LimitsProcDetails NTC_Temp
        {
            get
            {
                if (_NTC_Temp == null)
                {
                    ...
                    {
                        Values = new LimitsDetails(false, 24, 10, 11),
                        Avg = new LimitsDetails(true, 24, 10, 11),
                        StdDev = new LimitsDetails(true, 0, 0, 0.1),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
                return _NTC_Temp;
        ...
        public static LimitsProcDetails PT1_UNTC
        {
            get
            {
                if (_PT1_UNTC == null)
                {
                    ...
                    {
                        Values = new LimitsDetails(false, 30900, 20022, 20023),
                        Avg = new LimitsDetails(true, 30900, 20020, 20021),
        ...
        public static LimitsProcDetails PT1_Temp
        {
            get
            {
                if (_PT1_Temp == null)
                {
                    ...
                    {
                        Values = new LimitsDetails(false, 20, 10, 11),
        ...
        public static LimitsProcDetails PT2_UNTC
        {
            get
            {
                if (_PT2_UNTC == null)
                {
                    ...
                    {
                        Values = new LimitsDetails(false, 30900, 20032, 21033, 200),
                        Avg = new LimitsDetails(true, PT1_UNTC.Avg.Set, 20030, 20031, 200),
                        StdDev = new LimitsDetails(true, 0, 0, 0.6),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
        ...
        public static LimitsProcDetails PT2_Temp
        {
            get
            {
                if (_PT2_Temp == null)
                {
                    ...
                    {
                        Values = new LimitsDetails(false, 30, 1, 1),
                        Avg = new LimitsDetails(true, 30, 1, 1),
                        StdDev = new LimitsDetails(true, 0, 0, 0.1),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
        ...
        public static LimitsProcDetails NTC_UNTC
        {
            get
            {
                if(_NTC_UNTC == null)
                {
                    _NTC_UNTC = new LimitsProcDetails()
                    {
                        Values = new LimitsDetails(false, 12900, 300, 300),
                        Avg = new LimitsDetails(true, 12900, 300, 300),
                        StdDev = new LimitsDetails(true, 0, 0, 0.03),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
        ...
        public static LimitsProcDetails NTC_Temp
        {
            get
            {
                if (_NTC_Temp == null)
                {
                    _NTC_Temp = new LimitsProcDetails()
                    {
                        Values = new LimitsDetails(false, 25, 1, 1),
                        Avg = new LimitsDetails(true, 25, 1, 1),
                        StdDev = new LimitsDetails(true, 0, 0, 0.1),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
        ...
        public static LimitsProcDetails PT1_Temp
        {
            get
            {
                if (_PT1_Temp == null)
                {
                    _PT1_Temp = new LimitsProcDetails()
                    {
                        Values = new LimitsDetails(false, 20, 1, 1),
                        Avg = new LimitsDetails(true, 20, 1, 1),
                        StdDev = new LimitsDetails(true, 0, 0, 0.1),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
        ...
        public static LimitsProcDetails PT2_UNTC
        {
            get
            {
                if (_PT2_UNTC == null)
                {
                    _PT2_UNTC = new LimitsProcDetails()
                    {
                        Values = new LimitsDetails(false, PT1_UNTC.Avg.Set, 300, 300, 200),
                        Avg = new LimitsDetails(true, PT1_UNTC.Avg.Set, 500, 500, 200),
                        StdDev = new LimitsDetails(true, 0, 0, 0.6),
                        MinMaxDiff = new LimitsDetails(true, 0, 0, 2)
                    };
                }
