namespace CaliboxLibrary
{
    public class InternalProcesses
    {
        ...
        *
        *               IDIA: move all integrated functions and processes
        *               to library
        ***********************************************************/
        ...
        //private void DeviceCom_DataReceived(object sender, EventDataArgs e)
        //{
        ...
        //{
        //    DeviceCom.SetProgressAsync(code, error, value);
        //}
        //private void Set_Progress(BoxMode boxMode, BoxErrorMode error, string value = null)
        //{
        //    DeviceCom.SetProgressAsync(boxMode, error, value);
        //}
        ...
        //    Set_Progress(boxMode, error: BoxErrorMode.NotChecked, value: ItemValues.Cal_Desc);
        //    ProcessWorker.Executed();
        //}
        ...
        //    var boxMode = BoxMode.FromHex(ItemValues.CalMode);
        //    Set_Progress(boxMode, error: BoxErrorMode.FromHex(state), value: ItemValues.Cal_Desc);
        ...
        //    {
        //        OpCodeAnswerReceive = data.OpCodeResp;
        ...
        //        if (_processCount == 0)
        //        {
        //            _processCount = Processes.ProcOrders.Count;
        //        }
        ...
        //            case gProcMain.StartProcess:
        //                processeNr = 0;
        //                ProcesseRunning = Processes.ProcOrders[0].ProcName;
        //                nextProcess = true;
        //                break;
        //            default:
        //                nextProcess = true;
        ...
        //            ProcesseRunning = Processes.ProcOrders[processeNr].ProcName;
        ...
        //    {
        //        CheckFinalize();
        //        //NoError = CheckFinalize(DeviceCom.ResponseLast);
        //    }
        //    catch { }
        //}
        ...
        //    //}
        //}
        //private bool CheckFinalize(DeviceResponseValues drv = null)
        //{
        //    if (DeviceCom.ResponseContainsError(out drv))
        //    {
        //        return true;
        //    }
        //    if (DeviceCom.ResponseContainsFinalized(out drv))
        //    {
        //        return true;
        //    }
        //    return false;
