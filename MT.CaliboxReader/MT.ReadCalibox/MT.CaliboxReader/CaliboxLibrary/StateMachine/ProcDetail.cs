...
namespace CaliboxLibrary
{
    ...
    public class ProcDetail
    {
        ...
        public ProcDetail(gProcMain process, CmdSend send) : this(process)
        {
            CMD = send;
        }
        ...
        public CmdSend CMD { get; set; } = new CmdSend();
        ...
        public ProcTimes ProcessTimes { get; set; } = new ProcTimes();
        ...
        * DESCRIPTION:
        ***********************************************************/
        public ProcTimes TimeOut { get; set; } = new ProcTimes();

        public DateTime TimeOutStartTime { get; set; }
        public bool TimeOutActive
        {
            get { return TimeOut.Active; }
            set { TimeOut.Active = value; }
        }

        public int TimeOutDuration

        {
            get { return TimeOut.Duration; }
        ...
        * DESCRIPTION:
        ***********************************************************/
        public ProcTimes WaitExecutionBefore { get; set; } = new ProcTimes();
        public bool WaitBeforeExecuted { get; set; }
        public bool WaitBeforeActive
        {
            get { return WaitExecutionBefore.Active; }
            set { WaitExecutionBefore.Active = value; }
        }
        public int WaitBeforeDuration
        {
            get { return WaitExecutionBefore.Duration; }
            set { WaitExecutionBefore.Duration = value; }
        }

        public ProcTimes WaitExecutionAfter { get; set; } = new ProcTimes();
        public bool WaitAfterExecuted { get; set; }
        public bool WaitAfterActive
        {
            get { return WaitExecutionAfter.Active; }
            set { WaitExecutionAfter.Active = value; }
        }

        public int WaitAfterDuration
        {
            get { return WaitExecutionAfter.Duration; }
            set { WaitExecutionAfter.Duration = value; }
        }
    ...
    public class ProcTimes
    {
        ...
        {
            var result = TimeFinished - DateTime.Now;
            return result;
        }
        ...
        public void Start()
        {
            ...
            TimeFinished = TimeStarted.AddMilliseconds(Duration);
        }
